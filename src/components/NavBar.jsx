...
export const NavBar = () => {
  ...
  className={cn(
    ...
    isScrolled
      ? "py-3 bg-white/5 backdrop-blur-lg border-b border-white/10 shadow-xs"
      : "py-5 bg-white/5 backdrop-blur-lg"
  )}
    >
        ...
        <div className="container flex items-center justify-between">
            <a className="text-xl font-bold text-primary flex items-center" href="#hero">
             <span relative z-10>
                <span className="text-glow text-foreground">IsaacTech</span> Portfolio
             </span>
            </a>
            {/*Desktop nav*/}
